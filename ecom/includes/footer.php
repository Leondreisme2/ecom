    ...
    <div class="container">
        ...
        <div class="row mt-2">
            ...
            <div class="col-md-6 text-md-end small">
                <a href="privacy.php" class="text-decoration-none text-light opacity-75 me-3">Privacy</a>
                <a href="terms.php" class="text-decoration-none text-light opacity-75">Terms</a>
            </div>
        </div>
    </div>
</footer>